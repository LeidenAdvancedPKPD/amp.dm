...
- Fixed issues for `attr_factor` to retain attributes and added option to set largest group first (#11)
- Added function `flag_outliers` to flag observations for outliers based on box.plot stats
...
This the initial version of the package, evolved from multiple in-house developed functions and packages
